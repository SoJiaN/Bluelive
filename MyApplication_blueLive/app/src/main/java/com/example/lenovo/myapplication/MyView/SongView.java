...
//        return false;
        ...
        mControlPoints.add(new PointF(150, 200));
        mControlPoints.add(new PointF(300, 300));
        mControlPoints.add(new PointF(500, 260));
        mControlPoints.add(new PointF(600, 300));
        mControlPoints.add(new PointF(700, 360));
