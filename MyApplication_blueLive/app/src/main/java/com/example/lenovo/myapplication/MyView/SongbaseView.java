 ...
 *
 */
public abstract class SongbaseView extends SurfaceView implements Callback, Runnable {
	/**绘图渲染频率 正常**/
	...
	public SongbaseView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SongbaseView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * 设置刷新频率
	 * 
	 * @params SongbaseView.RENDER_RATE_NORMAL,</br>
	 *         SongbaseView.RENDER_RATE_SLOWLY,</br> SongbaseView.RENDER_RATE_FAST
	 */
